import { IndependentPlatformPlugin, Logging, PlatformConfig, API, CharacteristicEventTypes, CharacteristicGetCallback, CharacteristicValue, CharacteristicSetCallback, HAP, PlatformAccessory, Characteristic, Service } from "homebridge";
...
export class HomepodRadioPlatform implements IndependentPlatformPlugin {
    ...
    constructor(
        public logger: Logging, private config: PlatformConfig, private api: API) {
        ...
        this.api.on('didFinishLaunching', () => {
            this.logger.debug('Finished initializing platform:', this.config.platform);
            this.addAccessories();
        });
    }
